...
goog.maybeProcessDeferredDep_ = function(a) {
    ...
    goog.maybeProcessDeferredPath_(goog.basePath + 
    a))
}
,
...
goog.needsTranspile_ = function(a) {
    ...
    if (!goog.transpiledLanguages_) {
        ...
        try {
            ...
            eval('(()=>{"use strict";let a={};const X=class{constructor(){}x(z){return new Map([...arguments]).get(z[0])==3}};return new X().x([a,3])})()') && (goog.transpiledLanguages_["es6-impl"] = !1),
...
goog.html.SafeStyle.create = function(a) {
    ...
    for (c in a) {
        ...
        d = goog.html.SafeStyle.INNOCUOUS_STRING) : (goog.asserts.fail("String value allows only [-,.\"'%_!# a-zA-Z0-9], rgb() and rgba(), got: " + 
        d),
...
goog.style.getContainerOffsetToScrollInto = function(a, b, c) {
    ...
    c ? (f += b - g / 2,
    d += e - a / 2) : 
    (f += Math.min(b, Math.max(b - g, 0)),
    d += Math.min(e, Math.max(e - a, 0)));
...
goog.style.getFontSize = function(a) {
    ...
    if (goog.userAgent.IE) {
        ...
        if (a.parentNode && a.parentNode.nodeType == goog.dom.NodeType.ELEMENT && String(c) in goog.style.CONVERTIBLE_RELATIVE_CSS_UNITS_)
            ...
            goog.style.getIePixelValue_(a, b == c ? "1em" : b, 
            "left", "pixelLeft")
    }
...
goog.events.KeyCodes.firesKeyPressEvent = function(a, b, c, d, e) {
    ...
    if (!c && (b == goog.events.KeyCodes.CTRL || b == goog.events.KeyCodes.ALT || goog.userAgent.MAC && b == goog.events.KeyCodes.META))
        return !1;
...
goog.events.KeyHandler.prototype.handleKeyDown_ = function(a) {
    ...
    goog.events.KeyHandler.USES_KEYDOWN_ && !goog.events.KeyCodes.firesKeyPressEvent(a.keyCode, this.lastKey_, a.shiftKey, a.ctrlKey, a.altKey) ? this.handleEvent(a) : (this.keyCode_ = goog.events.KeyCodes.normalizeKeyCode(a.keyCode),
...
goog.events.KeyHandler.prototype.handleEvent = function(a) {
    ...
    d = 
    goog.events.KeyCodes.isCharacterKey(c) ? b.keyCode : 0) : (c = b.keyCode || this.keyCode_,
    d = b.charCode || 0,
...
goog.ui.Menu.prototype.highlightNextPrefix = function(a) {
    ...
    return this.highlightHelper(function(a, d) {
        ...
        do {
            ...
            if (g && g.match(b))
                return a
        } while (!f || a != e);return this.getHighlightedIndex()
...
goog.debug.enhanceError = function(a, b) {
    var c;
    "string" == typeof a ? (c = Error(a),
    Error.captureStackTrace && Error.captureStackTrace(c, goog.debug.enhanceError)) : c = a;
...
goog.ui.tree.TypeAhead.prototype.jumpTo_ = function(a) {
    ...
    if (c) {
        ...
        b && b.length && d && (this.matchingNodeIndex_ = a == goog.ui.tree.TypeAhead.Offset.UP ? b.length - 
        1 : 0));
    ...
    if (b.isConnected()) {
        ...
        Blockly.Events.recordUndo)) {
            ...
            setTimeout(function() {
                ...
                e.outputConnection ? e.outputConnection.bumpAwayFrom_(b) : 
...
Blockly.Field.prototype.updateEditable = function() {
    this.EDITABLE && this.fieldGroup_ && (this.sourceBlock_.isEditable() ? (Blockly.addClass_(this.fieldGroup_, "blocklyEditableText"),
    Blockly.removeClass_(this.fieldGroup_, "blocklyNonEditableText"),
    this.fieldGroup_.style.cursor = this.CURSOR) : (Blockly.addClass_(this.fieldGroup_, "blocklyNonEditableText"),
...
Blockly.Scrollbar.prototype.onMouseDownHandle_ = function(a) {
    ...
    Blockly.Scrollbar.onMouseUpWrapper_ = Blockly.bindEvent_(document, "mouseup", this, this.onMouseUpHandle_),
    Blockly.Scrollbar.onMouseMoveWrapper_ = Blockly.bindEvent_(document, "mousemove", this, this.onMouseMoveHandle_),
    a.stopPropagation(),
    a.preventDefault())
}
;
...
Blockly.Xml.blockToDom = function(a) {
    ...
    if (c = a.getCommentText())
        c = goog.dom.createDom("comment", null , 
        c),
        "object" == typeof a.comment && (c.setAttribute("pinned", a.comment.isVisible()),
        d = a.comment.getBubbleSize(),
        c.setAttribute("h", d.height),
        c.setAttribute("w", d.width)),
        b.appendChild(c);
    a.data && (c = goog.dom.createDom("data", null , a.data),
    b.appendChild(c));
    for (c = 0; d = a.inputList[c]; c++) {
        var h;
        f = !0;
        d.type != Blockly.DUMMY_INPUT && (g = d.connection.targetBlock(),
        d.type == Blockly.INPUT_VALUE ? h = goog.dom.createDom("value") : d.type == Blockly.NEXT_STATEMENT && (h = goog.dom.createDom("statement")),
        e = d.connection.getShadowDom(),
        !e || g && g.isShadow() || h.appendChild(Blockly.Xml.cloneShadow_(e)),
        g && (h.appendChild(Blockly.Xml.blockToDom(g)),
        f = !1),
...
Blockly.ZoomControls.prototype.position = function() {
    ...
    a.toolboxPosition == Blockly.TOOLBOX_AT_RIGHT && (this.left_ -= a.flyoutWidth)),
    this.top_ = a.viewHeight + 
    a.absoluteTop - this.HEIGHT_ - this.bottom_,
    a.toolboxPosition == Blockly.TOOLBOX_AT_BOTTOM && (this.top_ -= a.flyoutHeight),
    this.svgGroup_.setAttribute("transform", "translate(" + this.left_ + "," + this.top_ + ")"))
}
;
...
Blockly.WorkspaceSvg.prototype.traceOn = function(a) {
    this.traceOn_ = a;
    this.traceWrapper_ && (Blockly.unbindEvent_(this.traceWrapper_),
...
Blockly.WorkspaceSvg.prototype.onMouseDown_ = function(a) {
    this.markFocused();
    Blockly.isTargetInput_(a) || (Blockly.terminateDrag_(),
    Blockly.hideChaff(),
    ...
    Blockly.isRightButton(a) ? this.showContextMenu_(a) : this.scrollbar && (this.dragMode_ = Blockly.DRAG_BEGIN,
    ...
    "mouseup" in Blockly.bindEvent_.TOUCH_MAP && (Blockly.onTouchUpWrapper_ = Blockly.onTouchUpWrapper_ || [],
...
Blockly.BlockSvg.prototype.onMouseUp_ = function(a) {
    ...
    this.workspace.trashcan.close()) : !this.getParent() && Blockly.selected.isDeletable() && this.workspace.isDeleteArea(a) && ((a = this.workspace.trashcan) && goog.Timer.callOnce(a.close, 100, a),
...
Blockly.BlockSvg.prototype.renderCompute_ = function(a) {
    ...
    for (var d = 0, e = 0, f = !1, g = !1, h = !1, k = void 0, m = this.getInputsInline() && !this.isCollapsed(), p = 0, l; l = b[p]; p++)
        if (l.isVisible()) {
            ...
            e = Math.max(e, l.fieldWidth)) : 
            (n.type == Blockly.INPUT_VALUE ? f = !0 : n.type == Blockly.DUMMY_INPUT && (h = !0),
...
Blockly.BlockSvg.prototype.renderDraw_ = function(a, b) {
    ...
    if (this.outputConnection)
        ...
        if (this.previousConnection) {
            ...
            b.rightEdge = Math.max(b.rightEdge, 
            100));
    ...
    this.svgPathLight_.setAttribute("transform", 
    "scale(-1 1)"),
    ...
    for (var g, h = 0, k, m, p = 0, l; l = e[p]; p++) {
        ...
        Blockly.BlockSvg.INLINE) {
            for (var q = 0; n = l[q]; q++)
                ...
                d.push("h", Blockly.BlockSvg.TAB_WIDTH - 
                2 - n.renderWidth),
            ...
            b.push("v", 
            q + .5)) : (b.push("M", e.rightEdge - 5 + "," + (h + Blockly.BlockSvg.TAB_HEIGHT - .7)),
            ...
            p == e.length - 1 || e[p + 1].type == 
            Blockly.NEXT_STATEMENT) && (a.push("v", Blockly.BlockSvg.SEP_SPACE_Y),
            this.RTL && b.push("v", Blockly.BlockSvg.SEP_SPACE_Y - 1),
            h += Blockly.BlockSvg.SEP_SPACE_Y);
        h += l.height
    }
...
Blockly.BlockSvg.prototype.renderDrawBottom_ = function(a, b, c) {
    ...
    a.push("a", Blockly.BlockSvg.CORNER_RADIUS + "," + Blockly.BlockSvg.CORNER_RADIUS + 
...
Blockly.BlockSvg.prototype.renderDrawLeft_ = function(a, b) {
    ...
    b.push("m", -.92 * 
    Blockly.BlockSvg.TAB_WIDTH + ",-0.5 q " + -.19 * Blockly.BlockSvg.TAB_WIDTH + ",-5.5 0,-11"),
...
Blockly.Events.filter = function(a, b) {
    ...
    for (var d = 0, e; e = c[d]; d++)
        for (var f = d + 1, g; g = c[f]; f++)
            ...
            c.splice(f, 1),
            f--) : e.type != Blockly.Events.UI || "click" != g.element || "commentOpen" != 
            e.element && "mutatorOpen" != e.element && "warningOpen" != e.element || (e.newValue = g.newValue,
            c.splice(f, 1),
            f--));
...
Blockly.FieldTextInput.prototype.widgetDispose_ = function() {
    ...
    return function() {
        var b = Blockly.FieldTextInput.htmlInput_
          , c = b.value;
        a.sourceBlock_ && (c = a.callValidator(c),
        c = null  === c ? b.defaultValue : c);
        a.setValue(c);
...
Blockly.Variables.flyoutCategory = function(a) {
    ...
    for (var b = [], c = 0; c < a.length; c++) {
        ...
        Blockly.Blocks.variables_get && (d = goog.dom.createDom("block"),
...
Blockly.FieldVariable.prototype.classValidator = function(a) {
    function b(a, b) {
        ...
        c == Blockly.Msg.RENAME_VARIABLE || c == Blockly.Msg.NEW_VARIABLE) && (c = null );
        return c
    }
    ...
    if (a == Blockly.Msg.NEW_VARIABLE)
        ...
        "")) ? (Blockly.Variables.renameVariable(a, a, c),
        a) : null 
}
;
...
Blockly.Generator.prototype.blockToCode = function(a) {
    ...
    if (goog.isString(b))
        return this.STATEMENT_PREFIX && (b = this.STATEMENT_PREFIX.replace(/%1/g, 
        "'" + a.id + "'") + b),
        this.scrub_(a, b);
    if (null  === b)
        return "";
...
Blockly.Flyout.prototype.setBackgroundPathHorizontal_ = function(a, b) {
    ...
    c ? (d.push("h", a + this.CORNER_RADIUS),
    d.push("v", b),
    ...
    d.push("a", this.CORNER_RADIUS, this.CORNER_RADIUS, 0, 0, 1, -this.CORNER_RADIUS, -this.CORNER_RADIUS)) : (d.push("a", this.CORNER_RADIUS, this.CORNER_RADIUS, 0, 0, 1, this.CORNER_RADIUS, 
    -this.CORNER_RADIUS),
...
Blockly.Flyout.prototype.blockMouseDown_ = function(a) {
    ...
    return function(c) {
        Blockly.terminateDrag_();
        Blockly.hideChaff(!0);
        Blockly.isRightButton(c) ? a.showContextMenu_(c) : (Blockly.Css.setCursor(Blockly.Css.Cursor.CLOSED),
        ...
        Blockly.Flyout.onMouseUpWrapper_ = Blockly.bindEvent_(document, "mouseup", b, b.onMouseUp_),
...
Blockly.Flyout.prototype.onMouseDown_ = function(a) {
    Blockly.isRightButton(a) || (Blockly.hideChaff(!0),
...
Blockly.Flyout.prototype.onMouseMoveBlock_ = function(a) {
    if (!("mousemove" == a.type && 1 >= a.clientX && 0 == a.clientY && 0 == a.button))
        if (this.determineDragIntention_(a.clientX - Blockly.Flyout.startDownEvent_.clientX, a.clientY - Blockly.Flyout.startDownEvent_.clientY))
...
Blockly.Flyout.prototype.isDragTowardWorkspace_ = function(a, b) {
    ...
    if (this.horizontalLayout_)
        this.toolboxPosition_ == Blockly.TOOLBOX_AT_TOP ? c < 90 + e && c > 90 - e && (d = !0) : c > -90 - e && c < -90 + e && (d = !0);
    else if (this.toolboxPosition_ == Blockly.TOOLBOX_AT_LEFT)
        c < e && c > -e && (d = !0);
    else if (c < -180 + e || c > 180 - e)
        d = !0;
    return d
}
;
...
Blockly.Toolbox.prototype.position = function() {
    ...
    if (a) {
        var b = this.workspace_.getParentSvg()
          ...
          , b = Blockly.svgSize(b);
        this.horizontalLayout_ ? (a.style.left = c.x + "px",
        a.style.height = "auto",
        a.style.width = b.width + "px",
        this.height = a.offsetHeight,
        a.style.top = this.toolboxPosition == Blockly.TOOLBOX_AT_TOP ? c.y + "px" : c.y + b.height - a.offsetHeight + "px") : (a.style.left = this.toolboxPosition == Blockly.TOOLBOX_AT_RIGHT ? c.x + b.width - a.offsetWidth + "px" : c.x + "px",
    ...
    for (var d = null , e = 0, f; f = a.childNodes[e]; e++)
        if (f.tagName)
            ...
            case "CATEGORY":
                ...
                goog.isString(g) ? (g.match(/^#[0-9a-fA-F]{6}$/) ? d.hexColour = g : d.hexColour = Blockly.hueToRgb(g),
                this.hasColours_ = !0) : d.hexColour = "";
                "true" == f.getAttribute("expanded") ? (d.blocks.length && 
                this.tree_.setSelectedItem(d),
                d.setExpanded(!0)) : d.setExpanded(!1);
                d = f;
                break;
            case "SEP":
                d && ("CATEGORY" == d.tagName.toUpperCase() ? b.add(new Blockly.Toolbox.TreeSeparator(this.treeSeparatorConfig_)) : (f = parseFloat(f.getAttribute("gap")),
                isNaN(f) || (g = parseFloat(d.getAttribute("gap")),
                f = isNaN(g) ? f : g + f,
                d.setAttribute("gap", f))));
                break;
            case "BLOCK":
            case "SHADOW":
                b.blocks.push(f),
...
Blockly.Toolbox.TreeControl.prototype.setSelectedItem = function(a) {
    ...
    if (a != this.selectedItem_ && a != b.tree_) {
        ...
        c != 
        a && c != this && (c = new Blockly.Events.Ui(null ,"category",c && c.getHtml(),a && a.getHtml()),
...
Blockly.init_ = function(a) {
    ...
    b.toolboxPosition == 
    Blockly.TOOLBOX_AT_RIGHT && (a.scrollX *= -1),
...
Blockly.inject.bindDocumentEvents_ = function() {
    Blockly.documentEventsBound_ || (Blockly.bindEvent_(document, "keydown", null , Blockly.onKeyDown_),
...
Blockly.bindEvent_ = function(a, b, c, d) {
    ...
    if (b in Blockly.bindEvent_.TOUCH_MAP)
        ...
        , g = 0, h; h = Blockly.bindEvent_.TOUCH_MAP[b][g]; g++)
